...
values
  ('c1211111-1111-4111-8111-111111111111','B12A_TEST','B12 Company A'),
  ('c1222222-2222-4222-8222-222222222222','B12B_TEST','B12 Company B');
...
where p.user_id='c1233333-3333-4333-8333-333333333333'
  and p.is_default;
...
select
  ...
  20
from public.portfolios p
where p.user_id='c1244444-4444-4444-8444-444444444444'
  and p.is_default;

set local role authenticated;
set local "request.jwt.claim.sub"='c1233333-3333-4333-8333-333333333333';
...
reset role;
set local role authenticated;
set local "request.jwt.claim.sub"='c1244444-4444-4444-8444-444444444444';
