...
const plist = [
  ...
  '    <string>' + xmlEscape(path.join(process.cwd(), "scripts", "with-pipeline-lock.mjs")) + '</string>',
  '    <string>--lock=solpient_daily.lock</string>',
  '    <string>--</string>',
  '    <string>' + xmlEscape(process.execPath) + '</string>',
...
console.log(JSON.stringify({
  ...
  command: process.execPath + " " + path.join(process.cwd(), "scripts", "with-pipeline-lock.mjs") + " --lock=solpient_daily.lock -- " + process.execPath + " " + path.join(process.cwd(), "scripts", "run-solpient-daily.mjs"),
  stdout: stdoutPath,
  stderr: stderrPath,
}, null, 2));
