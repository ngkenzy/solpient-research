...
export function companyEvidenceForTicker(ticker){
  ...
  return{
    ...
    metricObservations:[
      ...
      metric("pipeline_replacement_evidence","Pipeline replacement evidence",{
    ...
    businessAssessment:{
      business_quality_rating:"good",
      moat_rating:"moderate",
      pricing_power:"Product-level pricing power exists where patents, clinical differentiation and limited substitutes support it, but payer pressure, IRA exposure, competition and LOE materially constrain portfolio-wide pricing power.",
      revenue_model:"Diversified branded medicines and vaccines portfolio with product revenues, alliance revenues and royalties; economics depend on patent/exclusivity cycles and successful pipeline renewal.",
