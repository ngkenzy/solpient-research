export const PEER_SETS = {
  ADBE: [
    ...
    { ticker:"PTC", relationship_type:"reference", rationale:"Engineering and design software peer with recurring subscription economics and professional workflows." },
  ],
  DECK: [
  ...
  PFE: [
    { ticker:"MRK", relationship_type:"reference", rationale:"Large-cap biopharma peer with global medicines and vaccine economics." },
    { ticker:"BMY", relationship_type:"reference", rationale:"Large-cap biopharma peer with oncology concentration and patent-cycle exposure." },
    { ticker:"ABBV", relationship_type:"reference", rationale:"Large biopharma peer with major-product concentration, LOE management and acquisition-driven portfolio renewal." },
    { ticker:"LLY", relationship_type:"reference", rationale:"Large-cap innovation benchmark for pipeline productivity, growth and R&D economics." },
  ],
  BLBD: [
...
export const TRACKED_TICKERS = Object.freeze([
  ...
  "ICE","JPM","BSY","DCI","AOS","DPZ","ALSN","POWL","TILE","GIC","ESQ","PFE"
]);
