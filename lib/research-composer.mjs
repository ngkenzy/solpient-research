...
export function composeResearchV1({ company, baselinePayload, contextPack = {}, valuationHistory = [], asOfDate = new Date().toISOString().slice(0, 10) }) {
  ...
  const multipleCases = scenarioValues({ perShare: perShare.perShare, history: hist, peerMedian: peerMultiple, growthBase: normalizedGrowth ?? fcfGrowth5 ?? growth5 ?? revenueGrowth, valuationMetric:perShare.metric });
