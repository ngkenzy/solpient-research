...
export const UNIVERSE_SCREENING_VERSION="solpient-universe-screen-v2.1";
export const UNIVERSE_SELECTION_VERSION="solpient-100-selection-v2.1";
...
export function screenCompany(row={}){
  ...
  const sectorEvidence=assessSectorEvidence(row,profileName,technicalCoverage);
