...
import { classifyIssuerSector, UNIVERSE_SECTOR_MODEL_VERSION } from "./universe-sector-model-v2-2.mjs";
export const UNIVERSE_SCREENING_VERSION="solpient-universe-screen-v2.2";
export const UNIVERSE_SELECTION_VERSION="solpient-100-selection-v2.2";
